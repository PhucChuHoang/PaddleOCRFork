...
def generate_training_data_from_alignment(aligned_results):
    ...
    for result in aligned_results:
        ...
        # Skip EXTRA_OCR entries - exclude them from training data
        if status == 'EXTRA_OCR':
            continue
...
def main():
    ...
    images_folder = 'E:/Courses/Thesis/FinalizedData/QuaDaGieSiMa/img'  # Default images folder
    texts_folder = 'E:/Courses/Thesis/FinalizedData/QuaDaGieSiMa/txt'  # Default text files folder
    output_folder = 'E:/Courses/Thesis/FinalizedData/QuaDaGieSiMa/aligned'  # Default output folder
