...
DET_MODEL_DIR = '/kaggle/working/PaddleOCRFork/models/det'
REC_MODEL_DIR = '/kaggle/working/PaddleOCRFork/models/rec_nom'
REC_CHAR_DICT_PATH = '/kaggle/working/PaddleOCRFork/ppocr/utils/dict/new_nom_dict.txt'
REC_IMAGE_SHAPE = '3,48,48'
REC_ALGORITHM = 'SVTR'
CONVERT_DICT_PATH = '/kaggle/working/PaddleOCRFork/ppocr/utils/dict/combined_unique_chars.txt'
