...
ocr = PaddleOCR(
    ...
    rec_model_dir='inference/customized/svtr_large/chinese',
...
def visualize_results(image, result, output_path='visualized_output.jpg'):
    ...
    try:
        ...
        print(f"Loaded dictionary with {len(nom_dict)} entries")
...
visualize_results(img, result[0], output_path='output/visualized_chinese.png')