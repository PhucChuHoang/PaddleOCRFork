...
def main():
    ...
    # Set up paths
    input_base_dir = os.path.join('E:/Courses/Thesis/FinalizedData/QuaDaGieSiMa', 'cropped')
    output_base_dir = 'E:/Courses/Thesis/FinalizedData/QuaDaGieSiMa/organized_by_char_index'
